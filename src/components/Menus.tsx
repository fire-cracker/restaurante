...
const MenusSection: FC<Props> = ({ menuRef }): ReactElement => (
                    ...
                    <Col lg={6} className="media-col mb-5">
                      <Media>
                        <img
                          ...
                          height={150}
                          className="mr-3"
                          src="https://food.fnr.sndimg.com/content/dam/images/food/fullset/2013/7/29/0/BX0903H_cinnamon-baked-doughnuts-recipe_s4x3.jpg.rend.hgtvcom.966.725.suffix/1449692373072.jpeg"
                          alt="Generic placeholder"
                        />
                        <Media.Body className="pt-1">
                          <h5 className="mb-3 pb-2 d-flex flex-row justify-content-between">
                            Media Heading <span className="text-darkkhaki">$300</span>
                          </h5>
